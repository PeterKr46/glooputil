...
public abstract class VisibleTransform extends Transform
{
    ...
    public VisibleTransform(Vector position, Scene scene, String tag, String name)
    {
        super(position, scene, tag, name);
    }

    public VisibleTransform(Vector position, Scene scene, Transform parent, String tag, String name)
    {
