 ...
 */
/*public abstract class GUEllipsoid extends Transform
{
    ...
    {
        return defaultScale[0]*0.5*getScaleX();
    }

    public double getRadY()
    {
        return defaultScale[1]*0.5*getScaleY();
    }

    public double getRadZ()
    {
        return defaultScale[2]*0.5*getScaleZ();
    }
